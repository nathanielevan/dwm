...
static const char *fonts[]          = { "FantasqueSansMono Nerd Font:pixelsize=15.5:antialias=true:autohint=true" };
static const char dmenufont[]       = "FantasqueSansMono Nerd Font:pixelsize=15.5:antialias=true:autohint=true";
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_Escape, spawn,          {.v = rofiwincmd } },
