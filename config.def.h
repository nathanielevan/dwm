...
static const unsigned int iconspacing = 2;      /* systray icon spacing */
...
static const char *fonts[]          = { "InconsolataGo Nerd Font:size=11:antialias=true:autohint=true" };
static const char dmenufont[]       = "InconsolataGo Nerd Font:size=11:antialias=true:autohint=true";
...
static const char *j4dmenucmd[] = { "j4-dmenu-desktop", "--dmenu", "dmenu -i -p \"drun:\"", "--term", "st", "--no-generic", NULL };
